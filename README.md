...
2D axisymmetric finite-volume thermal solver for turbulent Al2O3–water
...
- 1/7-power-law velocity profile + mixing-length eddy diffusivity (k-epsilon reserved)
...
python scripts/run_parameter_sweep.py    # Re × φ sweep, Nu & effectiveness

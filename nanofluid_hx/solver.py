...
class ThermalSolver:
    ...
    def assemble_system(self):
        ...
        # (always parallel: every stream +z, entrance at z = 0). Counterflow
        # reverses the annulus z-columns here; u negates, scalars do not.
        ...
        for i in range(self.mesh.Nr):
            ...
            for j in range(self.mesh.Nz):
                ...
                if is_west_bound:
                    ...
                    # Inner Cell: Link to West neighbor (harmonic mean over
                    # cell-center spacing, consistent with the radial treatment)
